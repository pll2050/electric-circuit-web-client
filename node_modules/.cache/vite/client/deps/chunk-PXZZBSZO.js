import {
  ...
  RenderingManager,
  SmartArray
} from "./chunk-OSQ2SMT4.js";
import {
  PerfCounter
} from "./chunk-CQ7PS2VE.js";
import {
  BaseTexture,
  Texture
...
} from "./chunk-XMW2X2EC.js";
import {
  EffectWrapper
} from "./chunk-AMGE7NYK.js";
import {
  GetClass,
  RegisterClass
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-TWQF4ZNV.js").then((module) => this._dumpTools = module);
    }
...
var PostProcess = class _PostProcess {
  ...
  _gatherImports(useWebGPU = false, list) {
    if (useWebGPU && this._webGPUReady) {
      list.push(Promise.all([import("./postprocess.vertex-GNKIYMZY.js")]));
    } else {
      list.push(Promise.all([import("./postprocess.vertex-2D5DXH3H.js")]));
    }
  }
  /**
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callback = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-L3VFCFUO.js");
    const textures = [];
...
var ThinPassPostProcess = class _ThinPassPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./pass.fragment-C55VEJOO.js")]));
    } else {
      list.push(Promise.all([import("./pass.fragment-CHGMCG3C.js")]));
    }
...
var ThinPassCubePostProcess = class _ThinPassCubePostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(Promise.all([import("./passCube.fragment-YO4ARVFL.js")]));
    } else {
      list.push(Promise.all([import("./passCube.fragment-AHJZ5O2Y.js")]));
    }
    super._gatherImports(useWebGPU, list);
  }
  /**
...
var ProcessAsync = async (texture, width, height, face, lod) => {
  ...
  if (!engine.isWebGPU) {
    if (texture.isCube) {
      await import("./lodCube.fragment-AXXFJNCS.js");
    } else {
      await import("./lod.fragment-6EE7BJKK.js");
    }
  } else {
    if (texture.isCube) {
      await import("./lodCube.fragment-GD6L7WCB.js");
    } else {
      await import("./lod.fragment-C7SNFGP3.js");
    }
  }
  let lodPostProcess;
  if (!texture.isCube) {
...
//# sourceMappingURL=chunk-PXZZBSZO.js.map
