...
async function _CreateDumpRenderer() {
  if (!_enginePromise) {
    _enginePromise = new Promise((resolve, reject) => {
      ...
      import("./thinEngine-JS4DZOZ4.js").then(({ ThinEngine: thinEngineClass }) => {
        ...
        import("./pass.fragment-CHGMCG3C.js").then(({ passPixelShader }) => {
          if (!engine) {
...
//# sourceMappingURL=chunk-GKR65DON.js.map
