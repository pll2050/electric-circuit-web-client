...
var RGBDTextureTools = class {
  ...
  static ExpandRGBDTexture(texture) {
    ...
    const expandRGBDTexture = async () => {
      ...
      internalTexture.isReady = false;
      if (isWebGPU) {
        await import("./rgbdDecode.fragment-FPUURU3M.js");
      } else {
        await import("./rgbdDecode.fragment-FQVPTUGJ.js");
      }
  ...
  static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
    if (!scene.getEngine().isWebGPU) {
      await import("./rgbdEncode.fragment-66FEQS5L.js");
    } else {
      await import("./rgbdEncode.fragment-TOOT5SKO.js");
    }
...
//# sourceMappingURL=chunk-DFX4K7XI.js.map
